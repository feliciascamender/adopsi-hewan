    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <div>
                ...
                <span class="text-pink-500 font-bold text-base"> BJM</span>
            </div>
        </div>
        <div class="flex items-center gap-2 sm:gap-3">
            <a href="{{ route('login') }}"
               class="text-sm text-gray-600 hover:text-pink-600 font-medium px-3 py-1.5 transition-colors">
                Masuk
            </a>
            <a href="{{ route('register') }}"
               class="text-sm bg-pink-600 hover:bg-pink-700 text-white font-medium
                      px-4 py-1.5 rounded-lg transition-colors shadow-sm shadow-pink-200">
                Daftar Gratis
            </a>
        </div>
    </div>
...
{{-- ============================================================
     HERO SECTION
     ============================================================ --}}
<section class="bg-gradient-to-br from-pink-50 via-white to-rose-50 py-20 sm:py-28">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 class="text-4xl sm:text-5xl font-bold text-gray-900 mb-5 leading-tight">
            ...
            <span class="text-pink-600">di Banjarmasin</span>
        </h1>
        ...
        <div class="flex flex-wrap items-center justify-center gap-3">
            <a href="{{ route('register') }}"
               class="bg-pink-600 hover:bg-pink-700 text-white font-semibold
                      px-7 py-3 rounded-xl transition-colors shadow-md shadow-pink-200 text-sm">
...
<section class="py-14 bg-white">
    <div class="max-w-5xl mx-auto px-4 sm:px-6">
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
            <div class="text-center p-6 rounded-2xl bg-pink-50 border border-pink-100">
                <p class="text-3xl font-bold text-pink-600">{{ $stats['total_animals'] }}</p>
...
<section class="py-14 bg-gray-50">
    <div class="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden
                ...
                <div class="p-4">
                    ...
                    <a href="{{ route('login') }}"
                       class="block text-center text-xs font-semibold bg-pink-50 hover:bg-pink-100
                              text-pink-600 py-2 rounded-lg transition-colors">
                        Login untuk Adopsi
                    </a>
                </div>
            </div>
        ...
        <div class="text-center mt-10">
            <a href="{{ route('login') }}"
               class="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div class="flex flex-col items-center p-6">
                <div class="w-14 h-14 bg-pink-100 rounded-2xl flex items-center justify-center text-2xl mb-4 shadow-sm">
                    1️⃣
                </div>
...
{{-- ============================================================
     CTA SECTION
     ============================================================ --}}
<section class="py-14 bg-gradient-to-r from-pink-600 to-rose-600">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3">
            Siap Memberikan Rumah yang Hangat?
        </h2>
        <p class="text-pink-100 mb-8 text-sm leading-relaxed max-w-xl mx-auto">
        ...
        <a href="{{ route('register') }}"
           class="inline-block bg-white hover:bg-pink-50 text-pink-600 font-bold
